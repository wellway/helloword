...
import com.excel.poiutil.PoiExcel2k3Helper;
import com.excel.poiutil.PoiExcel2k7Helper;
import com.excel.poiutil.PoiExcelHelper;
...
public abstract class PoiExcelTest {
	...
	public static void main(String[] args){
		// 获取Excel文件的sheet列表
//		testGetSheetList("F:/document/行情文档/（行情指标数据库表）2013.05.xlsx");
		
		// 获取Excel文件的第1个sheet的内容
		testReadExcel("E:/SwClass112.xls", 0);

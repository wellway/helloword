...
public class FastJsonTest {
	...
	public void toJsonString() {
		User user = new User("testFastJson001", "maks", 105,new Address("广东省", "深圳市", "科苑南路", "580053"));
		String text = JSON.toJSONString(user);
		System.out.println("toJsonString()方法：entityToJsonString-->text=" + text);
	...
	public void parseBeanObject() {
		String text = "{\"age\":105,\"id\":\"testFastJson001\",\"name\":\"maks\",\"id\":\"maks\"}";
	...
	/**
	 * 全序列化 直接把javabean序列化为json文本之后，
	 * 能够按照原来的类型反序列化回来。支持全序列化，需要打开SerializerFeature
	 * .WriteClassName特性
	 */

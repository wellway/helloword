...
public class FastJsonTest1 {
	...
	public void json2list() {
		String jsonText = "[{\"age\":16,\"id\":\"P001\",\"name\":\"TOM\"},{\"age\":21,\"id\":\"P002\",\"name\":\"JACKSON\"},{\"age\":20,\"id\":\"P003\",\"name\":\"MARTIN\"}]";
		List<User> list = JSON.parseArray(jsonText, User.class);
		System.out.println("json2list<T>方法" + list);
	}

	/**
	 * json转list<Map<String,Object>>
	 */
	public void json2listMap() {
		String jsonText = "[{\"age\":16,\"id\":\"P001\",\"name\":\"TOM\"},{\"age\":21,\"id\":\"P002\",\"name\":\"JACKSON\"},{\"age\":20,\"id\":\"P003\",\"name\":\"MARTIN\"}]";
		List<Map<String, Object>> list = JSON.parseObject(jsonText,
				new TypeReference<List<Map<String, Object>>>() {
				});
		System.out.println("json2list<Map>方法" + list);
	}
